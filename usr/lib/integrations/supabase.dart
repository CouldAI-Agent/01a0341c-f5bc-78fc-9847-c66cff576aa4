...
// Project ID: xocdfncbpidrsbprmtsq

class SupabaseConfig {
  const SupabaseConfig._();

  static const String supabaseUrl = 'https://xocdfncbpidrsbprmtsq.supabase.co';
  static const String supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhvY2RmbmNicGlkcnNicHJtdHNxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODU1NzMzNjgsImV4cCI6MjEwMTE0OTM2OH0.V5nliQaC0Z7CkowNNxaU8NtpHMwnIacM-G_lertKLYQ';
